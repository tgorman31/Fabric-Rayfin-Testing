...
const emptyDependency: DependencyInput = {
  predecessor_item_definition_guid: "", successor_item_definition_guid: "", dependency_type: "FS", lag_days: 0, successor_field: "target_end",
};
const emptyMapping: MappingInput = {
  reporting_item_definition_guid: "", reporting_field: "reporting_start", target_item_definition_guid: "", target_field: "target_start", reporting_reference_item_definition_guid: undefined,
};
...
export function AdminPage() {
  ...
  const [dependencyForm, setDependencyForm] = useState<DependencyInput>(emptyDependency);
  const [editingDependencyId, setEditingDependencyId] = useState<string | null>(null);

  const [mappingForm, setMappingForm] = useState<MappingInput>(emptyMapping);
