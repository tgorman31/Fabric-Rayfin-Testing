...
Read the [architecture overview](../architecture/architecture-overview.md) and [threat model](threat-model.md) for system boundaries and scenario-level analysis, the [production-readiness register](production-readiness-register.md) for trackable open questions, and [`IMPLEMENTATION-PLAN.md`](../../IMPLEMENTATION-PLAN.md) for planned engineering direction.
